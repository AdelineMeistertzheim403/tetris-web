...
export const normalizeBoard = (input: string[] | number[][]): number[][] => {
...
export async function loadPuzzles(): Promise<PuzzleSeedRow[]> {
  const path = resolve(__dirname, "puzzles.json");
  const raw = await readFile(path, "utf-8");
  return JSON.parse(raw) as PuzzleSeedRow[];
}

export const generatedPuzzles: PuzzleSeedRow[] = [
  {
    id: "puzzle-gen-001",
...
export const patternBoards: Record<string, string[]> = {
  trench: [
    "..........",
    "..........",
    "..........",
...
export const generateBatch = (): PuzzleSeedRow[] => {
