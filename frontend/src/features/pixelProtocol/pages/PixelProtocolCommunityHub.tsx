...
export default function PixelProtocolCommunityHub() {
  ...
  useEffect(() => {
    ...
    void fetchPixelProtocolCommunityLevels()
      .then((levels) => {
        if (cancelled) return;
  ...
  const handleToggleCommunityLike = async (level: PixelProtocolCommunityLevel) => {
  ...
  return (
    <div className="pp-hub font-['Press_Start_2P']">
      <div className="pp-hub-shell">
        <h1 className="pp-hub-title">Niveaux joueurs</h1>
